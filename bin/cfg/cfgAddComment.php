...
if (!class_exists("commandCfgAddComment")) {
    class commandCfgAddComment extends driverCommand {
        ...
        public static function getHelp() {
            return array(
                "description" => "Add a comment to configuration.", 
                "parameters" => array(
                    'section' => 'Section.',
...
return new commandCfgAddComment();