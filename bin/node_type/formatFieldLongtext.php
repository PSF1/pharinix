...
if (!class_exists("commandFormatFieldLongtext")) {
    class commandFormatFieldLongtext extends driverCommand {
...
EOT;
        ...
        public static function getHelp() {
            return array(
                "description" => "Format longtext field to read or write.", 
                "parameters" => array(
...
return new commandFormatFieldLongtext();