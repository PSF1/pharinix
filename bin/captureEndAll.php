...
if (!class_exists("commandCaptureEndAll")) {
    class commandCaptureEndAll extends driverCommand {

        public static function runMe(&$params, $debug = true) {
            if (!isset(self::$register["captureCounter"])) {
                self::$register["captureCounter"] = 0;
            }
            while (self::$register["captureCounter"] > 0) {
...
return new commandCaptureEndAll();